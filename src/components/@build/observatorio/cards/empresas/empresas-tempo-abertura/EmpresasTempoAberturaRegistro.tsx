...
const EmpresasTempoAberturaRegistro = ({
  data,
  title = `Tempo Médio Registro de Empresas`,
  compare,
  toCompare,
  ...
  color,
    ...
    const chartData = dataFiltred.find(data => data?.['Municipio'] === compare)?.['Tempo_Medio_Registro'] || 0
    
    const chartData2 = dataFiltred.find(data => data?.['Municipio'] === toCompare)?.['Tempo_Medio_Registro'] || 0
...
export default EmpresasTempoAberturaRegistro
