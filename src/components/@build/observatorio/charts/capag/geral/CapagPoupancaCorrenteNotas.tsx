...
const CapagPoupancaCorrenteNotas = ({
  data,
  colors = ColorPalette.default,
  title = "Capag Poupança Corrente Notas",
  }: any) => {
    type DataMunicipio = { Município: string }[]

    const uniqueMunicipios: string[] = getUniqueValues((data || []) as DataMunicipio, 'Município');

    const chartData = processCapagAnoPilar(data, 'Poupança Corrente')
...
export default CapagPoupancaCorrenteNotas;
