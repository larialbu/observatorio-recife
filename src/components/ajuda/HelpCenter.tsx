  ...
  const cardData = [
    {
        ...
        icon: (
          <svg className="fill-[#0155AE]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 10.999h2C22 5.869 18.127 2 12.99 2v2C17.052 4 20 6.943 20 10.999z"/>
            <path d="M13 8c2.103 0 3 .897 3 3h2c0-3.225-1.775-5-5-5v2zm3.422 5.443a1.001 1.001 0 0 0-1.391.043l-2.393 2.461c-.576-.11-1.734-.471-2.926-1.66-1.192-1.193-1.553-2.354-1.66-2.926l2.459-2.394a1 1 0 0 0 .043-1.391L6.859 3.513a1 1 0 0 0-1.391-.087l-2.17 1.861a1 1 0 0 0-.29.649c-.015.25-.301 6.172 4.291 10.766C11.305 20.707 16.323 21 17.705 21c.202 0 .326-.006.359-.008a.992.992 0 0 0 .648-.291l1.86-2.171a1 1 0 0 0-.086-1.391l-4.064-3.696z"/>
          </svg>
        ),
        detailedDescription: 'Para entrar em contato com o suporte, você pode nos enviar um e-mail. Nosso time de suporte está disponível para resolver qualquer problema técnico ou esclarecer dúvidas sobre o uso da plataforma.',
    },
    {
      title: 'Acessibilidade e Usabilidade',
      description: 'Dicas sobre como personalizar sua experiência para ser mais acessível.',
      icon: (
        <svg viewBox="0 0 24 24" className="fill-[#52B348]" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="fill-none stroke-2 stroke-[#EC6625]" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.9998 9.00023V13.0002M11.9998 17.0002H12.0098M10.6151 3.89195L2.39019 18.0986C1.93398 18.8866 1.70588 19.2806 1.73959 19.6039C1.769 19.886 1.91677 20.1423 2.14613 20.309C2.40908 20.5002 2.86435 20.5002 3.77487 20.5002H20.2246C21.1352 20.5002 21.5904 20.5002 21.8534 20.309C22.0827 20.1423 22.2305 19.886 22.2599 19.6039C22.2936 19.2806 22.0655 18.8866 21.6093 18.0986L13.3844 3.89195C12.9299 3.10679 12.7026 2.71421 12.4061 2.58235C12.1474 2.46734 11.8521 2.46734 11.5935 2.58235C11.2969 2.71421 11.0696 3.10679 10.6151 3.89195Z" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
...
const Card: React.FC<CardProps> = ({ title, description, icon, detailedDescription }) => {
  ...
  return (
    ...
    >
      ...
      <p
        className={`text-sm text-gray-800 dark:text-white transition-all duration-300 ${isHovered ? 'opacity-100' : 'opacity-75'} ${isHovered ? 'max-h-full' : 'max-h-[60px] overflow-hidden'}`}
      >
